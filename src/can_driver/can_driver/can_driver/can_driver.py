    ...
    def shutdown(self):
        ...
        if hasattr(self, 'notifier'):
            try:
                ...
                self.get_logger().error(f"Failed to stop CAN notifier: {e}")
        ...
        if hasattr(self, 'bus'):
            try:
                ...
                self.get_logger().error(f"Failed to shut down CAN bus: {e}")
...
def main(args=None):
    ...
    try:
        ...
        if can_driver_node is not None:
